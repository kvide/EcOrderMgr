...
echo $this->ShowTemplateList($id, $returnid, 'confirmorder_', 'systemdflt_confirmorder_template', 'confirmorder',
    'dflt_confirmorder_template', $this->Lang('addedit_confirmorder_template'), '', 'admin_templates');
