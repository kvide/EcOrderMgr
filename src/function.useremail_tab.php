...
$smarty->assign('formstart', $this->XTCreateFormStart($id, 'admin_setuseremail_prefs', $returnid));
$smarty->assign('formend', $this->CreateFormEnd());
$smarty->assign('submit', $this->CreateInputSubmit($id, 'submit', $this->Lang('submit')));
$smarty->assign('prompt_email_subject', $this->Lang('email_subject'));
$smarty->assign('input_email_subject',
    $this->CreateInputText($id, 'email_subject', $this->GetPreference('useremail_subject'), 100, 255));

echo $this->ProcessTemplate('useremail_tab.tpl');

$this->EditDefaultTemplateForm($this, $id, $returnid, 'useremail_template', 'useremail',
    $this->Lang('title_useremail_template'), 'orig_useremail_template.tpl',
    $this->Lang('info_useremail_template'), 'admin_templates');
