...
$query = 'SELECT feu_user_id FROM ' . cms_db_prefix() . 'module_ec_ordermgr
           WHERE id = ?';
...
$smarty->assign('return_link', $this->CreateImageLink($id, 'admin_viewmessages', $returnid, $this->Lang('return'),
