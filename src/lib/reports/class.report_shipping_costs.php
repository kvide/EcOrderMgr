...
class report_shipping_costs extends \EcOrderMgr\report_base
{
    ...
    {
        $query = 'SELECT oi.*,os.*,oo.invoice,oo.create_date FROM ' . cms_db_prefix() . 'module_ec_ordermgr_items oi
               ...
               WHERE oo.status != \'proposed\'
                 ...
                 AND oo.status != \'hold\'
                 AND oi.item_type = \'' . EcOrderMgr\LineItem::ITEMTYPE_SHIPPING . '\'
