...
echo $this->ShowTemplateList($id, $returnid, 'invoice_', 'systemdflt_invoice_template', 'invoice',
    'dflt_invoice_template', $this->Lang('addedit_invoice_template'), '', 'admin_templates');
