  ...
  <table align="center" border="1" width="100%">
    ...
    {foreach from=$shipping->get_items() item='item' name='items'}
      <tr>
        ...
        <td align="right">{if $item->get_weight() != ''}{$item->get_weight()|number_format:2}{$weightunits}{/if}</td>
        <td align="right">{$currencysymbol}{$item->get_unit_price()|number_format:2}</td>
        <td align="right">{if $item->get_discount() != ''}{$currencysymbol}{$item->get_discount()|number_format:2}{/if}</td>
