...
echo $this->ShowTemplateList($id, $returnid, 'gateway_complete_', 'systemdflt_gateway_complete_template',
    'gateway_complete', 'dflt_gateway_complete_template', $this->Lang('addedit_gateway_complete_template'),
    '', 'admin_templates');
