...
$templates = $db->GetArray($query);
if (count($templates))
{
    $smarty->assign('templates', $templates);
}

$smarty->assign('link_newtemplate', $this->CreateImageLink($id, 'admin_addmsgtemplate', $returnid,
    $this->Lang('add_msg_template'), 'icons/system/newobject.gif', array(), '', '', false));

echo $this->ProcessTemplate('messagetemplates_tab.tpl');
