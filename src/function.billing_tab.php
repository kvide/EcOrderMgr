...
echo $this->ShowTemplateList($id, $returnid, 'billingform_', 'systemdflt_billingform_template', 'billing',
    'dflt_billingform_template', $this->Lang('addedit_billingform_template'), '', 'admin_templates');
