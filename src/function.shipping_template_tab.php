...
echo $this->ShowTemplateList($id, $returnid,
    'shippingform_', 'systemdflt_shippingform_template', 'shipping', 'dflt_shippingform_template',
    $this->Lang('addedit_shippingform_template'), '', 'admin_templates');
